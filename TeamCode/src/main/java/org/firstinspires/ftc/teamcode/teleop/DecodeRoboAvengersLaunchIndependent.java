...
@TeleOp(name = "Decode RoboAvengers (Independent Launchers)", group = "RoboAvengers")
public class DecodeRoboAvengersLaunchIndependent extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            // --------------- UNJAM MANUAL ---------------
            if (gamepad2.x
                    && leftState == DecodeRoboAvengersLaunchIndependent.LaunchState.IDLE
                    && rightState == DecodeRoboAvengersLaunchIndependent.LaunchState.IDLE) {
                startReverseUnjam();
            }
