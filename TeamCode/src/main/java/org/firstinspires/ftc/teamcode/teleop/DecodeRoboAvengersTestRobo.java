...
@Disabled
@TeleOp(name = "Decode Robo Center Test", group = "RoboAvengers")
public class DecodeRoboAvengersTestRobo extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (leftLauncher != null) {
            ...
            // Direction chosen so positive velocity is correct spin direction
        ...
        telemetry.addLine("TeleOp READY (robot-centric)");
        telemetry.update();
        waitForStart();
        ...
        if (rightLauncher != null) {
            rightLauncher.setVelocityPIDFCoefficients(P_GAIN, I_GAIN, D_GAIN, LEFT_F_GAIN);
        }
    ...
    // ---------------- Independent Launch Logic (RPM-based) ----------------
    ...
    private void launchLeft(boolean shootRequested, boolean unjamRequested) {
        ...
        switch (leftState) {
            ...
            case SPIN_UP:
                if (leftReady()) {
                    // small stability delay after ready
